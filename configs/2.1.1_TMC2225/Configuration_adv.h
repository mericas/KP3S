 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       850        // (mA) RMS current. Multiply by 1.414 for peak current.  Based on max of 1.5A from Kingroon email
  ...
  #if AXIS_IS_TMC(Y)
    #define Y_CURRENT       850		// (mA) RMS current. Multiply by 1.414 for peak current.  Based on max of 1.5A from Kingroon email
  ...
  #if AXIS_IS_TMC(Z)
    #define Z_CURRENT       850		// (mA) RMS current. Multiply by 1.414 for peak current.  Based on max of 1.5A from Kingroon email
  ...
  #if AXIS_IS_TMC(E0)
    #define E0_CURRENT      560		// (mA) RMS current. Multiply by 1.414 for peak current.  Based on max of 1A from Kingroon email
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_24V        // All axes (override below)   ** change to 24V
