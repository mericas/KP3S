 ...
 */
  ...
  #if AXIS_IS_TMC(X)
    #define X_CURRENT       800        // (mA) RMS current. Multiply by 1.414 for peak current.  May want to change to 850 for all
   ...
   */
  #define CHOPPER_TIMING CHOPPER_DEFAULT_12V        // All axes (override below)   ** change to 24V
